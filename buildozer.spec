...
# (str) Package name
package.name = beerwhapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.beerwhapp

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,xml,db,pem
...
requirements = python3,sqlite3,cython,certifi,charset-normalizer,idna,urllib3,requests,kivy==2.3.0,Kivy_Garden,docutils,pygments,asyncgui,asynckivy,materialyoucolor,pillow==10.3.0,https://github.com/kivymd/KivyMD/archive/master.zip,android,plyer,pyjnius==1.6.1,pypiwin32,numpy,opencv_extras,opencv,libiconv,libzbar,pyzbar==0.1.9
#python-dateutil,pytz,tzdata,chardet,setuptools
#requirements = python3,kivy==2.3.0,kivymd==1.2.0,Kivy_Garden,docutils==0.21.1,pillow==10.3.0,pygments,pypiwin32,pyjnius==1.6.1,cython,plyer==2.1.0,numpy,opencv_extras,opencv,android
#chardet,pandas,openpyxl==3.1.2,python-dateutil,pytz,tzdata,urllib3==2.2.1,certifi,idna,charset-normalizer==3.3.2
...
#android.permissions = android.permission.INTERNET,CAMERA,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION
android.permissions = android.permission.INTERNET,CAMERA,RECORD_AUDIO,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION
